...
op4[0] = new CriaMenu("Raça",null,"consulta_pet_raca.php");
op4[1] = new CriaMenu("Tipo",null,"consulta_pet_tipo.php");
op4[2] = new CriaMenu("Pet",null,"consulta_pet_frontend.php");
op4[3] = new CriaMenu("Serviço",null,"consulta_servico.php");
...
op4[10] = new CriaMenu("Função",null,"consulta_funcao.php");
op4[11] = new CriaMenu("Funcionário",null,"consulta_funcionario.php");
op4[12] = new CriaMenu("Funcionário Função",null,"consulta_funcionario_funcao.php");
op4[13] = new CriaMenu("Orçamento",null,"consulta_orcamento.php");
op4[14] = new CriaMenu("Pessoa",null,"consulta_pessoa.php");


var op3 = new Array(15);
op3[0] = new CriaMenu("Raça",null,"excluir_pet_raca_frontend.php");
op3[1] = new CriaMenu("Tipo",null,"excluir_pet_tipo_frontend.php");
op3[2] = new CriaMenu("Pet",null,"excluir_pet_frontend.php");
op3[3] = new CriaMenu("Serviço",null,"excluir_servico_frontend.php");
...
op3[10] = new CriaMenu("Funcao",null,"excluir_funcao_frontend.php");
op3[11] = new CriaMenu("Funcionário",null,"excluir_funcionario_frontend.php");
op3[12] = new CriaMenu("Funcionário Função",null,"excluir_funcionario_funcao_frontend.php");
op3[13] = new CriaMenu("Orçamento",null,"excluir_orcamento_frontend.php");
op3[14] = new CriaMenu("Pessoa",null,"excluir_pessoa_frontend.php");


var op2 = new Array(15);
op2[0] = new CriaMenu("Raça",null,"alterar_pet_raca_frontend.php");
op2[1] = new CriaMenu("Tipo",null,"alterar_pet_tipo_frontend.php");
op2[2] = new CriaMenu("Pet",null,"alterar_pet_frontend.php");
op2[3] = new CriaMenu("Serviço",null,"alterar_servico_frontend.php");
...
op2[10] = new CriaMenu("Função",null,"alterar_funcao_frontend.php");
op2[11] = new CriaMenu("Funcionário",null,"alterar_funcionario_frontend.php");
op2[12] = new CriaMenu("Funcionario Função",null,"alterar_funcionario_funcao_frontend.php");
op2[13] = new CriaMenu("Orçamento",null,"alterar_orcamento_frontend.php");
op2[14] = new CriaMenu("Pessoa",null,"alterar_pessoa_frontend.php");

var op1 = new Array(15);
op1[0] = new CriaMenu("Raça",null,"incluir_pet_raca_frontend.php");
op1[1] = new CriaMenu("Tipo",null,"incluir_pet_tipo_frontend.php");
op1[2] = new CriaMenu("Pet",null,"incluir_pet_frontend.php");
op1[3] = new CriaMenu("Serviço",null,"incluir_servico_frontend.php");
...
op1[10] = new CriaMenu("Funçao",null,"incluir_funcao_frontend.php");
op1[11] = new CriaMenu("Funcionário",null,"incluir_funcionario_frontend.php");
op1[12] = new CriaMenu("Funcionario Função",null,"incluir_funcionario_funcao_frontend.php");
op1[13] = new CriaMenu("Orçamento",null,"incluir_orcamento_frontend.php");
